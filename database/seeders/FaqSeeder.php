...
class FaqSeeder extends Seeder
{
    ...
    {
        // Get category IDs
        $penerbitanId = Category::where('slug', 'penerbitan')->where('type', Category::TYPE_FAQ)->first()?->id;
        $royaltiId = Category::where('slug', 'royalti')->where('type', Category::TYPE_FAQ)->first()?->id;
        $teknisId = Category::where('slug', 'teknis')->where('type', Category::TYPE_FAQ)->first()?->id;
        $umumId = Category::where('slug', 'umum')->where('type', Category::TYPE_FAQ)->first()?->id;
